...
| GET | `/api/ RegExp(/^\/customers(?:\/)\/beauty-profile\/?(?=\/|$)/i) ` | getProfile |
| POST | `/api/ RegExp(/^\/customers(?:\/)\/beauty-profile\/?(?=\/|$)/i) ` | getProfile |
| PUT | `/api/ RegExp(/^\/customers(?:\/)\/beauty-profile\/?(?=\/|$)/i) ` | getProfile |
| PATCH | `/api/ RegExp(/^\/customers(?:\/)\/beauty-profile\/?(?=\/|$)/i) ` | getProfile |
