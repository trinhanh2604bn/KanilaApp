...
public class OrderListUiState {
    ...
    public OrderListUiState(boolean loading, List<OrderSummaryDto> orders, String error, boolean empty) {
    ...
    public static OrderListUiState loading() {
        return new OrderListUiState(true, null, null, false);
    }

    public static OrderListUiState success(List<OrderSummaryDto> orders) {
        return new OrderListUiState(false, orders, null, false);
    }

    public static OrderListUiState error(String message) {
        return new OrderListUiState(false, null, message, false);
    }

    public static OrderListUiState empty() {
        return new OrderListUiState(false, null, null, true);
    }
}
